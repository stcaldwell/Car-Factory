...
class Factory {
  ...
  static customerBuild(color, trim, model, options) {
...
class Sport extends Car {
  constructor(model, trim, transmission, top, color, seattrim, audio, wheelstrim) {
    super(model, trim, transmission, color, seattrim, audio, wheelstrim);
    this.top = top;
    this.moonroof = false;
...
var mazda3 = new Car('mazda3', 4, 'red', 'hybrid', 'automatic', 'touring', 'base', 'audio', 'leather', true)
...
console.log(Factory.customerBuild('yellow', 'touring', 'Mazda3', ['weather package ', 'satellite radio ', 'rear spoiler.']));
...
var miataRf = new Sport('Miata-RF', 'Grand Touring', 'manual', 'hard top', 'red', 'laether', 'premium', 'premium');
...
console.log(Factory.massBuild(15000, 'Red', 'Grand Touring', 'Miata-RFs'))
...
console.log(Factory.customerBuild('Black', 'Grand Touring', 'Miata-Rf', ['hid headlights', 'sports suspension', 'leather steering wheel', 'heated seats', 'adaptive cruise control']));
...
var trailBlazer = new Truck('Trail Blazer', 'blue', 'Sport', 8, true, 'standard', true, 2);
...
console.log(Factory.customerBuild('red', 'Sport', 'Trail Blazer', ['seat warmers', 'tinted windows', 'fog lamps']));
